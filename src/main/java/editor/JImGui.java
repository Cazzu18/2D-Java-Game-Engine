...
//TODO: Review https://github.com/codingminecraft/MarioYoutube/commit/84c5031acf9ac87b40f5e08cb160d04993f62eb1 for more properties panel features
...
public class JImGui {
    ...
    public static void drawVec2Control(String label, Vector2f values, float resetValue, float columnWidth){
        ...
        ImGui.columns(2); //two columns. One for label one for vector control
        ...
        ImGui.dragFloat("##x", vecValuesX, 0.2f);
        ImGui.popItemWidth();
        ImGui.sameLine();
        ...
        ImGui.popStyleColor(3);//3count

        ImGui.sameLine();
        float[] vecValuesY = {values.y};
        ImGui.dragFloat("##y", vecValuesY, 0.2f);
        ImGui.popItemWidth();
        ImGui.sameLine();

        // Position | b _____ b _____
        ImGui.nextColumn();
    ...
    public static void drawVec3Control(String label, Vector3f values, float resetValue, float columnWidth){
        ...
        float lineHeight = ImGui.getFontSize() + ImGui.getStyle().getFramePaddingY() * 2.0f;
        Vector2f buttonSize = new Vector2f(lineHeight + 3.0f, lineHeight); //because we have 3 controls
    ...
    public static float dragFloat(String label, float value){
        ...
        float[] valArr = {value};
        ImGui.dragFloat("##dragFloat", valArr, 0.2f);
        ImGui.columns(1);
        ImGui.popID();
    ...
    public static int dragInt(String label, int value){
        ...
        int[] valArr = {value};
        ImGui.dragInt("##dragInt", valArr, 0.2f);
        ImGui.columns(1);
        ImGui.popID();
